...
'/grizzlypaws-backend/project-root/assets/images/Cat/Category 1 - Dry Cat Food/Category 1 - Products/Product 1 - Orijen Original/OrijenCat4.png',
...
'/grizzlypaws-backend/project-root/assets/images/Cat/Category 1 - Dry Cat Food/Category 1 - Products/Product 2 - Aozi Cat Food/AoziKitten2.png',
...
'/grizzlypaws-backend/project-root/assets/images/Cat/Category 1 - Dry Cat Food/Category 1 - Products/Product 4 - Vitality/VitalityCat2.jpg',
    ...
    },
    {
        ...
        "images": [
            ...
            "/grizzlypaws-backend/project-root/assets/images/Cat/Category 1 - Dry Cat Food/Category 1 - Products/Product 6 - Natural Balance/NaturalBalancee.png"
        ],
    ...
    },
    {
        ...
        "images": [
            ...
            "/grizzlypaws-backend/project-root/assets/images/Cat/Category 1 - Dry Cat Food/Category 1 - Products/Product 8 - Special Cat Urinary/SpecialCatUrinary3.png"
        ],
...
'/grizzlypaws-backend/project-root/assets/images/Cat/Category 2 - Wet Cat Food/Product 2- Feline Gourmet/FelineGourmet3.png',
'/grizzlypaws-backend/project-root/assets/images/Cat/Category 2 - Wet Cat Food/Product 2- Feline Gourmet/FelineGourmet4.png',
...
'/grizzlypaws-backend/project-root/assets/images/Cat/Category 2 - Wet Cat Food/Product 4 - Weruva Chicken & Tuna Formula in Gravy/WeruvaSalmon.png',
'/grizzlypaws-backend/project-root/assets/images/Cat/Category 2 - Wet Cat Food/Product 4 - Weruva Chicken & Tuna Formula in Gravy/WeruvaSalmon2.png',
...
'/grizzlypaws-backend/project-root/assets/images/Cat/Category 2 - Wet Cat Food/Product 6 - KitCat Gravy Wet Food/KitCatCLassicTUna2.png',
...
'/grizzlypaws-backend/project-root/assets/images/Cat/Category 3 - Cat Treats & Snacks/Category 3 - Treats - Products/Product 4 -Applaws Tuna Loin Treat/ApplawsTunaLoin1.jpg',
...
'/grizzlypaws-backend/project-root/assets/images/Cat/Category 3 - Cat Treats & Snacks/Category 3 - Treats - Products/Product 6 - Smilla Toothies Dental Care Snack/SmillaToothiesk.jpg',
...
'/grizzlypaws-backend/project-root/assets/images/Cat/Category 3 - Cat Treats & Snacks/Category 3 - Treats - Products/Product 8 - Inaba Churu Purée/InabChuru2.png',
...
'/grizzlypaws-backend/project-root/assets/images/Cat/Category 5 - Cat Beds & Furniture/Category 5 - Cat Bed and Furnitures - Products/Product 7- Cuddle Den/CuddleDen4.jpg',
...
'/grizzlypaws-backend/project-root/assets/images/Cat/Category 10 -  Cat Collars & Accessories/Category 10 - Accessories/Product 10-  Cosmo Dual Feeding Bowl/CosmaDual3.jpg',
    ...
    //     "images": [
    //       '/grizzlypaws-backend/project-root/assets/images/default-product-image.png',
    //       '/grizzlypaws-backend/project-root/assets/images/default-product-image.png',
    //     ],
    ...
    //     "sub_category": "Aquarium Sand",
    //     "images": [
    //       '/grizzlypaws-backend/project-root/assets/images/Aquatic/Category 1 - Aquarium Sand, Gravel & Substrates/Category 1 - Products/Product 10 - , Turquoise and Yellow, 3.5 oz/Capture.PNG',
    //       '/grizzlypaws-backend/project-root/assets/images/Aquatic/Category 1 - Aquarium Sand, Gravel & Substrates/Category 1 - Products/Product 10 - Imagitarium Aquarium Gem Gravel Accents, Turquoise and Yellow, 3.5 oz/Capture1.PNG',
    //       '/grizzlypaws-backend/project-root/assets/images/Aquatic/Category 1 - Aquarium Sand, Gravel & Substrates/Category 1 - Products/Product 2 - Imagitarium Neon Aquarium Gravel Substrate, Pink, 5 lbs/confetti.PNG'
    //     ],
...
'/grizzlypaws-backend/project-root/assets/images/Aquatic/Category 1 - Aquarium Sand, Gravel & Substrates/Category 1 - Products/Product 9 - Fluval Bio Stratum Aquarium, 8.8 lbs/Capture2.PNG',
    ...
    //     "sub_category": "Aquarium Sand",
    //     "images": [
    //       '/grizzlypaws-backend/project-root/assets/images/Aquatic//grizzlypaws-backend/project-root/assets/images/Aquatic/Category 1 - Aquarium Sand, Gravel & Substrates/Category 1 - Products/Product 10 - Imagitarium Aquarium Gem Gravel Accents, Turquoise and Yellow, 3.5 oz/Capture.PNG',
    //         '/grizzlypaws-backend/project-root/assets/images/Aquatic//grizzlypaws-backend/project-root/assets/images/Aquatic/Category 1 - Aquarium Sand, Gravel & Substrates/Category 1 - Products/Product 10 - Imagitarium Aquarium Gem Gravel Accents, Turquoise and Yellow, 3.5 oz/Capture1.PNG'
    //     ],
...
// '/grizzlypaws-backend/project-root/assets/images/Aquatic/Category 5 -  Aquarium Decorations & Substrate/Category 5 - Products/Product 10 - Imagitarium Aquarium Gem Gravel Accents, Turquoise and Yellow, 3.5 oz/Capture.PNG',
// '/grizzlypaws-backend/project-root/assets/images/Aquatic/Category 5 -  Aquarium Decorations & Substrate/Category 5 - Products/Product 10 - Imagitarium Aquarium Gem Gravel Accents, Turquoise and Yellow, 3.5 oz/Capture1.PNG',
...
const subCategoryMapping = {
  ...
  "Small Pet Cages": 71,
  "Rabbit": 72,
  "Fencing for Small Pets": 73,
  "Small Pet Food": 74,
  "Cage Accessories": 75,
  "Snacks and Supplements": 76,
  "Hay and Straw": 77,
  "Small Pet Toys": 78,
  "Care and Grooming": 79,
  "Small Pet Special Offers": 80,
  "Bird Foods": 81,
  "Bird Cages": 82,
  "Bird Cage Accessories": 83,
  "Bird Snacks": 84,
  "Bird Toys": 85,
  "Bird Health": 86,
  "Bird Cage Bedding": 87,
  "Wild Birds": 88,
  "Feeding Supplies": 89,
  "Special Offers": 90,
  "Aquarium Sand": 91,
  ...
  "Aquarium Filters": 93,
  "Fish Food": 94,
  "Aquarium Decorations": 95,
  "Aquarium Lighting": 96,
  "Fish Health": 97,
  "Aquarium Maintenance": 98,
};
...
function generateProductInsert(product, index, productNumber) {
    // Validation: Check if product has required fields
    if (!product.name || product.name.trim() === '') {
        console.warn(`⚠️  Warning: Product at index ${index} is missing 'name' property. Skipping...`);
        console.warn(`   Product data:`, JSON.stringify(product, null, 2));
        return null; // Skip this product
    }
    
    const categoryId = categoryMapping[product.category] || 1;
    const subCategoryId = subCategoryMapping[product.sub_category] || 1;
    
    const name = escapeSQL(product.name);
    const description = product.description ? escapeSQL(product.description) : escapeSQL('No description available');
    const image1 = product.images && product.images[0] ? escapeSQL(product.images[0]) : 'NULL';
    const image2 = product.images && product.images[1] ? escapeSQL(product.images[1]) : 'NULL';
    const image3 = product.images && product.images[2] ? escapeSQL(product.images[2]) : 'NULL';
...
SET @product_id_${productNumber} = LAST_INSERT_ID();
`;
}

function generateVariationsInsert(product, index, productNumber) {
    if (!product.variations || product.variations.length === 0) {
        return '';
    }
    
    const values = product.variations.map(variation => {
        const unit = escapeSQL(variation.unit);
        const price = parseFloat(variation.price).toFixed(2);
        return `(@product_id_${productNumber}, ${unit}, ${price}, 10)`;
    }).join(',\n');
...
`;
    ...
    products.forEach((product, index) => {
        // Increment product number only for valid products
        const productNumber = validProductCount + 1;
        const productSQL = generateProductInsert(product, index, productNumber);
        
        if (productSQL === null) {
            skippedProductCount++;
            return; // Skip this product - don't add anything to SQL
        }
        
        // Only add to SQL if product is valid
        sql += productSQL;
        sql += generateVariationsInsert(product, index, productNumber);
        sql += '\n';
        validProductCount++;
    });

    console.log(`\n📊 Processing Summary:`);
    console.log(`   ✅ Valid products: ${validProductCount}`);
    console.log(`   ⚠️  Skipped products: ${skippedProductCount}`);
...
// STEP 5: OUTPUT THE SQL TO FILE
const fs = require('fs');
const sqlScript = generateSQL();

// Write to file - Change filename here if needed
const outputFilename = 'seeds.sql';
fs.writeFileSync(outputFilename, sqlScript, 'utf8');

console.log('✅ SQL seed file generated successfully!');
console.log(`📁 File: ${outputFilename}`);
console.log(`📊 Total products: ${products.length}`);
console.log(`🔢 Total variations: ${products.reduce((sum, p) => sum + (p.variations?.length || 0), 0)}`);
console.log('\n💡 Next steps:');
console.log('1. Review the seeds.sql file');
console.log('2. Update category and sub-category mappings if needed');
console.log('3. Run: mysql -u username -p database_name < seeds.sql');

// Optional: Also print preview to console (comment out if not needed)
// console.log('\n' + '='.repeat(60));
